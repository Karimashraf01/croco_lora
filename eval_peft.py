...
def get_args():
    ...
    parser.add_argument(
        "--checkpoint",
        # required=True,
        default=r"output\LoRA_on_ENCODER_Decoder_r16_qkv_proj_peft_filtered_data_increased_data\checkpoint-LoRA_on_ENCODER_Decoder_r16_qkv_proj_peft_filtered_data_increased_data-best.pth",
        help="Path to LoRA checkpoint folder"
    )
